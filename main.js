 ...
 * панель шрифта - возможность назначить шрифт
 ...
 * после чего история будет сбрасываться до текущей
 * Сохранять чертёж будут сервис-воркеры
 * Чертёж должен сохраняться в IndexDB
 * 
